...
//				查询图书的事件处理
		...
		mntmNewMenuItem_1 = new JMenuItem("修改图书");
		...
		mntmNewMenuItem_2 = new JMenuItem("添加图书");
		...
		mntmNewMenuItem_3 = new JMenuItem("删除图书");
		...
		mntmNewMenuItem_11 = new JMenuItem("删除借阅信息");
		...
		mntmNewMenuItem_11.setHorizontalAlignment(SwingConstants.CENTER);
		mnNewMenu_1.add(mntmNewMenuItem_11);
		
		mnNewMenu_2 = new JMenu("读者信息");
		mnNewMenu_2.setHorizontalAlignment(SwingConstants.CENTER);
		menuBar.add(mnNewMenu_2);
		
		mntmNewMenuItem_12 = new JMenuItem("查询读者");
...
//				查询读者的事件处理
		...
		mntmNewMenuItem_12.setHorizontalAlignment(SwingConstants.CENTER);
		mnNewMenu_2.add(mntmNewMenuItem_12);
		
		mntmNewMenuItem_13 = new JMenuItem("修改读者");
		...
		mntmNewMenuItem_13.setHorizontalAlignment(SwingConstants.CENTER);
		mnNewMenu_2.add(mntmNewMenuItem_13);
		
		mntmNewMenuItem_14 = new JMenuItem("添加读者");
		...
		mntmNewMenuItem_14.setHorizontalAlignment(SwingConstants.CENTER);
		mnNewMenu_2.add(mntmNewMenuItem_14);
		
		mntmNewMenuItem_15 = new JMenuItem("删除读者");
		...
		mntmNewMenuItem_15.setHorizontalAlignment(SwingConstants.CENTER);
		...
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblNewLabel_1.setText("<html><tr><td \"center\">帮助信息</td></tr>"
						...
						+ "<tr><td \"center\">读者信息：完成对读者信息的增删改查。</td></tr>"
